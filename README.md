# Note:- https://artifacthub.io/packages/helm/oteemo-charts/sonarqube heare we will get all type of helm charts
# CMD:-  helm install demo-chart --values values.yaml .
<!-- export POD_NAME=$(kubectl get pods --namespace default -l "app=sonarqube,release=demo-chart" -o jsonpath="{.items[0].metadata.name}")
  echo "Visit http://127.0.0.1:8080 to use your application"
  kubectl port-forward $POD_NAME 8080:9000 -n default -->

<!-- To forwared port inside pod run this CMD -->
  <!-- kubectl port-forward <pod-name> 8080:9000 -n default -->
